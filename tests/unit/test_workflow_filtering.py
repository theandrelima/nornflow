...
class TestWorkflowFiltering:
    ...
    def test_parameterless_filter(self, filters_catalog):
        ...
        inventory_filters = {
            "active": None  # This is how it would appear when parsed from YAML
        }
    ...
    def test_multi_parameter_filter_dict(self, filters_catalog):
        ...
        inventory_filters = {
            "location": {"city": "San Francisco", "building": "Office 1"}
        }
    ...
    def test_multi_parameter_filter_missing_param(self, filters_catalog):
        ...
        inventory_filters = {
            "location": {"city": "London"}  # Missing 'building'
        }
    ...
    def test_multi_parameter_filter_wrong_format(self, filters_catalog):
        ...
        inventory_filters = {
            "location": "London"  # Not a dict or list matching parameter count
        }
    ...
    def test_mixed_filters(self, filters_catalog):
        ...
        platform_filter = next((r for r in result if "filter_func" in r and r["filter_func"] == filter_by_platform), None)
        active_filter = next((r for r in result if "filter_func" in r and r["filter_func"] == filter_parameterless), None)
