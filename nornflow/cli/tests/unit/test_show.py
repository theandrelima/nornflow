...
class TestShowCommand:
    ...
    def test_show_all_flag(self, mock_show_nornir_configs, mock_show_settings, mock_show_catalog, mock_builder):
    ...
    @patch("nornflow.cli.show.show_nornflow_settings")
    @patch("nornflow.cli.show.show_nornir_configs")
    def test_show_catalog_flag(self, mock_show_nornir_configs, mock_show_settings, mock_show_catalog, mock_builder):
    ...
    @patch("nornflow.cli.show.show_nornflow_settings")
    @patch("nornflow.cli.show.show_nornir_configs")
    def test_show_settings_flag(self, mock_show_nornir_configs, mock_show_settings, mock_show_catalog, mock_builder):
    ...
    @patch("nornflow.cli.show.show_nornflow_settings")
    @patch("nornflow.cli.show.show_nornir_configs")
    def test_show_nornir_configs_flag(self, mock_show_nornir_configs, mock_show_settings, mock_show_catalog, mock_builder):
    ...
    @patch("nornflow.cli.show.show_nornflow_settings")
    @patch("nornflow.cli.show.show_nornir_configs")
    def test_show_with_settings_path(self, mock_show_nornir_configs, mock_show_settings, mock_show_catalog, mock_builder):
...
class TestShowHelpers:
    ...
    def test_show_catalog(self, mock_show_table):
        ...
        calls = [
            call("TASKS CATALOG", render_task_catalog_table_data, ["Task Name", "Description", "Location"], mock_nornflow),
            call("WORKFLOWS CATALOG", render_workflows_catalog_table_data, ["Workflow Name", "Description", "Location"], mock_nornflow),
            call("FILTERS CATALOG", render_filters_catalog_table_data, ["Filter Name", "Description", "Location"], mock_nornflow)
        ]
