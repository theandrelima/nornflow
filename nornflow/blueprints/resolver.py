...
class BlueprintResolver:
    ...
    def resolve_template(self, template_str: str, context: dict[str, Any]) -> str:
        ...
        try:
            ...
            raise BlueprintError(
                f"Failed to resolve blueprint template: {e}",
    ...
    def evaluate_condition(self, condition: str, context: dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise BlueprintError(
                f"Failed to evaluate blueprint condition: {e}",
    ...
    @staticmethod
    def _load_domain_defaults(vars_dir: Path, workflow_path: Path, workflow_roots: list[str]) -> dict[str, Any]:
